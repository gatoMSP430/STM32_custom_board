/**
  ...
  */
#include <stdint.h>
#define SYS_MEM_ADDR 0x1FFF0000U  // Bootloader base address for STM32L476
extern __attribute__((section(".noinit"))) uint32_t boot_flag;
